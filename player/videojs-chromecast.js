    ...
    _createClass(ChromeCastButton, [{
        ...
        value: function initializeApi() {
            ...
            if (!chrome.cast || !chrome.cast.isAvailable) {
                _videoJs2['default'].log('Transmissão não disponível');
                if (this.tryingReconnect < 10) {
                    this.setTimeout(this.initializeApi, 1000);
                    ++this.tryingReconnect;
                }
                _videoJs2['default'].log('Transmissão não disponível. Número de tentativas esgotadas');
                return;
            }
        ...
        value: function castError(_castError) {
            ...
            return _videoJs2['default'].log('Erro de transmissão: ' + JSON.stringify(_castError));
        }
    }, {
        key: 'onInitSuccess',
        ...
        value: function sessionJoinedListener(session) {
            ...
            return console.log('Sessão inicializada');
        }
    }, {
        ...
        value: function doLaunch() {
            ...
            if (this.apiInitialized) {
                ...
                return _videoJs2['default'].log('Sessão não inicializada');
            }
        }
    }, {
        ...
        value: function onSessionSuccess(session) {
            ...
            _videoJs2['default'].log('Sessão inicializada: ' + session.sessionId + ' origem : ' + source + ' tipo : ' + type);
            ...
            try {
                ...
                _videoJs2['default'].log('Erro ao pegar legendas do player: ' + e);
            }
...
var Chromecast = (function (_Tech) {
    ...
    _createClass(Chromecast, [{
        ...
        value: function onTrackSuccess() {
            return _videoJs2['default'].log('Legenda adicionada');
        }
    }, {
        key: 'onTrackError',
        value: function onTrackError(e) {
            return _videoJs2['default'].log('Erro de legenda: ' + JSON.stringify(e));
        }
    }, {
        key: 'castError',
        value: function castError(e) {
            return _videoJs2['default'].log('Erro de transmissão: ' + JSON.stringify(e));
        }
    }, {
        key: 'play',
        value: function play() {
        ...
        value: function onSeekSuccess(position) {
            _videoJs2['default'].log('Sucesso na progressão: ' + position);
        }
    }, {
        key: 'volume',
